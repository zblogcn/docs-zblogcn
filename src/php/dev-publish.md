...
<!-- https://bbs.zblogcn.com/thread-77001.html -->
...
1. 为节省时间，请先参照「[注意事项速查表](/php/dev-faq#注意事项速查表 "注意事项速查表")」进行自查；
...
注意事项速查表：https://docs.zblogcn.com/php/dev-faq  ←← 高优先级
...
> **推荐阅读：[注意事项速查表](/php/dev-faq#注意事项速查表 "常见问题")**
